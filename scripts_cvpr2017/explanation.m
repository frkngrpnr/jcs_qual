...
pos_emo_tr=[mean_emo_tr(:,4) mean_emo_tr(:,6)];
pos_emo_val=[mean_emo_val(:,4) mean_emo_val(:,6)];
pers_emo_feats_tr=[scores_final_elm_trcv(:,[1 2 3 5 6]) ]; % 
pers_emo_feats_val=[scores_final_elm_val(:,[1 2 3 5 6]) ]; % 

pers_emo_feats_mean=mean(pers_emo_feats_tr);
predictors={'AGREE','CONS','EXTRO','NEURO','OPEN'};% 
...
accuracy=sum(strcmp(class_cat_val,yp))/2000
