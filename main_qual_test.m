...
opts.learn_model=0; % if set to 1, it will learn regression models from features and write predictions
...
use_val = 0;
Nfold=8; % number of folds used to optimize parameters within labeled training set
%% 2. Data preparation
%% 2.1. Face alignment
...
% Step 3.3: Stack predictions of 3.1 and 3.2. subsystems to RF
rf_score_fusion
